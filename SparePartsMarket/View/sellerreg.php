...
<html lang = "en">
<head>
        <title>Spare Part Market |Seller Signup</title>
        <link rel="stylesheet" href="/SparePartsMarket/Css/sellerreg.css">
</head>
    <body>
        <nav class="navbar">
            <div class="top">
                ...
                <div class="right">
                <ul class="menu">
                    <li><a href="sellerlogin.php">Home</a></li>
        ...
        <table class="center">
            ...
            <tr><td><form action="\SparePartsMarket\PHP\Bike Handler\sellerregop.php" method="post"></tr></td>
            ...
            <tr><td><input type="text" id="Shopname" name="sname" placeholder="Shop-name" required></td></tr>
            <tr><td><input type="text" id="Shoplocation" name="slocation" placeholder="Shop-Location" required></td></tr>
            ...
            <tr><td>OR</td></tr>
            <tr><td><h2 class="item-title"><a href= "/SparePartsMarket/View/sellerlogin.php">Login</h2></td></tr>
            </form>
              </table> 
    </section>
